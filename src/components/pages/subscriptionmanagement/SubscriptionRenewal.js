...
const SubscriptionRenewal = () =>{
        ...
        fetch(API_URL+"/device/six/profile/" + userid,
            ...
            if (response.status == 200) {
                response.json().then((resp) => {
                    ...
                    payNow(resp.hardwareprofiles.length)
    ...
    const payNow = (_deviceLength) => {
        $("#paypal-button-container").html('')
       
        let _price =   _deviceLength == 1 ? "175" : _deviceLength > 1  ? parseFloat(175+60*(_deviceLength-1)) : 0 ; 
        ...
        <div className="wrp-dashbord pt-5">
            ...
            <div className="subscription-content">
               ...
               <ul className="anual-renew-list">
                   ...
                   <li><p>{deviceLength == 1 ? "$175" : deviceLength > 1  ? "$"+parseFloat(175+60*(deviceLength-1))  : "No Device Found" }</p></li>
               </ul>
